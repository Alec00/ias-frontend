		...
		<div class="row">
			<div class="col-xs-12">
				<div class="page_header">
					...
					<a href="#" class="btn btn-primary download_all"><span class="icon-download"></span></a>
			...
			<div class="col-xs-12">
				<div class="filter_box hidden-lg">
					...
					<button class="btn btn-primary filter_btn" data-toggle="modal" data-target="#news_filter_modal2">Налаштувати фільтр запиту</button>
				</div>
				...
				<div class="tab-content">
					<div class="tab-pane fade" id="tab1">
						...
						<table class="table table-striped table-bordered visible-lg wide_table">
							...
							<tr data-key="0">
								<td>
									<a href="#">Приватне підприємство «УКРТЕХГРУП-2006»</a>
									<div><span class="icon-compl-plan plan_icon" data-toggle="tooltip" data-placement="top" title="Є в комплексному плані"></span></div>
								</td>
								...
								<td class="result_table_action">
									...
									<a href="#" class="table_action_btn icon-alert" data-toggle="tooltip" data-placement="top" title="Порівняти з комплексним планом"></a>
								</td>
							</tr>
							<tr data-key="10">
								<td colspan="11" class="alert_row"></td>
							</tr>
							<tr data-key="1">
								<td>
									<a href="#">Приватне підприємство «УКРТЕХГРУП-2006»</a>
									<div><span class="icon-notplaned-check plan_icon" data-toggle="tooltip" data-placement="top" title="Позапланова"></span></div>
								</td>
								<td>на всій території України</td>
								<td>33580257</td>
								<td>додержання законодавства у сфері провадження туроператорської діяльності</td>
								...
								<td class="result_table_action">
									<a href="#" class="table_action_btn icon-details" data-toggle="tooltip" data-placement="top" title="Переглянути план"></a>
									<a href="#" class="table_action_btn icon-pencil" data-toggle="tooltip" data-placement="top" title="Редагувати план"></a>
									<a href="#" class="table_action_btn icon-archive" data-toggle="tooltip" data-placement="top" title="Додати в архів"></a>
									<a href="#" class="table_action_btn icon-garbage" data-toggle="tooltip" data-placement="top" title="Видалити"></a>
								</td>
							</tr>
							<tr data-key="2">
								<td>
									<a href="#">Приватне підприємство «УКРТЕХГРУП-2006»</a>
									<div><span class="icon-compl-check plan_icon" data-toggle="tooltip" data-placement="top" title="Комплексна"></span></div>
								</td>
								<td>на всій території України</td>
								<td>33580257</td>
								<td>додержання законодавства у сфері провадження туроператорської діяльності</td>
						...
						<table class="table table-striped table-bordered visible-lg wide_table">
							...
							<tr data-key="0">
								...
								<td class="result_table_action">
									...
									<a href="#" class="table_action_btn icon-pencil" data-toggle="tooltip" data-placement="top" title="Редагувати план"></a>
									<a href="#" class="table_action_btn icon-exchange" data-toggle="tooltip" data-placement="top" title="Порівняти з комплексним планом"></a>
									<a href="#" class="table_action_btn icon-alert active" data-toggle="tooltip" data-placement="top" title="Порівняти з комплексним планом"></a>
								</td>
							</tr>
							<tr data-key="10">
								<td colspan="11" class="alert_row">Не вдалося знайти суб'єкт господарювання</td>
							</tr>
							<tr data-key="1">
								<td>
									<a href="#">Приватне підприємство «УКРТЕХГРУП-2006»</a>
							...
							<tr data-key="2">
								...
								<td class="result_table_action">
									<a href="#" class="table_action_btn icon-details" data-toggle="tooltip" data-placement="top" title="Переглянути план"></a>
									<a href="#" class="table_action_btn icon-pencil" data-toggle="tooltip" data-placement="top" title="Редагувати план"></a>
									<a href="#" class="table_action_btn icon-edit2" data-toggle="tooltip" data-placement="top" title="Редагувати план"></a>
								</td>
							</tr>
							</tbody>
						</table>
					...
					<div class="result_table_mobile_item">
						...
						<div class="result_table_mobile_panel">
							...
							<div class="result_table_mobile_cell action_btns">
								<div class="alert_block">Не вдалося знайти суб'єкт господарювання</div>
...
<!-- news_filter_modal2 -->
<div class="modal fade" id="news_filter_modal2" tabindex="-1" role="dialog" aria-labelledby="faq_modal" aria-hidden="true">
	<div class="modal-dialog small_modal">
		...
		<div class="modal_filter">
			...
			<form action="/">
				...
				<div class="form-group">
					<label class="control-label">Помилки</label>
					<select class="selectpicker" style="width: 100%">
						<option>В стадії припинення</option>
						<option>Не вдалося знайти</option>
						<option>Не співпадає з КП</option>
					</select>
				</div>
				<div class="form-group">
