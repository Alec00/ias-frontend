			...
			<div class="col-xs-12 col-sm-8 col-md-9 pad_no_mob">
				<div class="create_doc_content">
					...
					<ul class="step_progress">
						<li class="active">Загальні дані</li>
						<li>Посвідчення</li>
						<li>Результати</li>
						<li>Санкції</li>
						<li>Оскарження</li>
                        ...
                        <div class="result_table_mobile edit_subject">
                            <div class="result_table_mobile_item">
                                <div class="collapse_btn">
                                    1. <u class="open_result_table">Суб`єкт</u>
						...
						<div class="result_table_mobile_item">
							<div class="collapse_btn">
								2. <u class="open_result_table">Загальна інформація</u>
								<button class="icon-angle-down open_result_table"></button>
							</div>
							<div class="result_table_mobile_panel">
								<div class="edit_subject_block">
						...
						<div class="result_table_mobile_item">
							<div class="collapse_btn">
								3. <u class="open_result_table">Інформація про суб’єкт господарювання</u>
								<button class="icon-angle-down open_result_table"></button>
							</div>
							<div class="result_table_mobile_panel">
								<div class="form-group">
						...
						<div class="result_table_mobile_item">
							<div class="collapse_btn">
								4. <u class="open_result_table">Розпорядчий документ, на виконання якого проводиться захід державного нагляду (контролю)</u>
								<button class="icon-angle-down open_result_table"></button>
							</div>
							<div class="result_table_mobile_panel">
								<div class="form-inline width-53">
						...
						<div class="result_table_mobile_item">
							<div class="collapse_btn">
								5. <u class="open_result_table">Посвідчення (направлення)</u>
								<button class="icon-angle-down open_result_table"></button>
							</div>
							<div class="result_table_mobile_panel">
								<div class="form-inline width-53">
						...
						<div class="result_table_mobile_item">
							<div class="collapse_btn">
								6. <u class="open_result_table">Строк проведення заходу державного нагляду (контролю)</u>
								<button class="icon-angle-down open_result_table"></button>
							</div>
							<div class="result_table_mobile_panel">
								<div class="edit_subject_block">
						...
						<div class="result_table_mobile_item">
							<div class="collapse_btn">
								7. <u class="open_result_table">Особи, що беруть участь у проведенні заходу державного нагляду (контролю)</u>
								<button class="icon-angle-down open_result_table"></button>
							</div>
							<div class="result_table_mobile_panel">
								<div class="edit_subject_block">
						...
						<div class="result_table_mobile_item">
							<div class="collapse_btn">
								8. <u class="open_result_table">Дані про останній проведений захід державного нагляду (контролю)</u>
								<button class="icon-angle-down open_result_table"></button>
							</div>
							<div class="result_table_mobile_panel">
								<div class="edit_subject_block">
						...
						<div class="result_table_mobile_item">
							<div class="collapse_btn">
								9. <u class="open_result_table">Інформація про результати заходу державного нагляду (контролю)</u>
								<button class="icon-angle-down open_result_table"></button>
							</div>
							<div class="result_table_mobile_panel">
								<div class="edit_subject_block">
