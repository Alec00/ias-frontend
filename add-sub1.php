					...
					<div class="add_sub_body">
						<div class="form-group-head">
							<div class="form-group required">
								...
								<input type="text" id="subject_name" class="form-control" name="" disabled placeholder="ТОВ «ІГОР БОРИСОВИЧ ГЕРМЕС»">
								<p class="help-block help-block-error"></p>
							</div>
							<div class="form-group">
								<label class="control-label" for="small_subject_name">Скорочена назва</label>
								<input type="text" id="small_subject_name" class="form-control" name="" disabled placeholder="ТОВ «ІГОР БОРИСОВИЧ ГЕРМЕС»">
							</div>
							<div class="form-group required">
								<label class="control-label" for="subject_edrpou">Код ЄДРПОУ</label>
								<input type="text" id="subject_edrpou" class="form-control" name="" disabled placeholder="12345678">
								<p class="help-block help-block-error"></p>
							</div>
							<div class="form-group required">
								<label class="control-label" for="subject_address">Адреса</label>
								<input type="text" id="subject_address" class="form-control" name="" disabled placeholder="65117, Одеська обл., місто Одеса, Суворовський район вулиця Затонського буд. 10 кв. 154 ">
								<p class="help-block help-block-error"></p>
							</div>
							<div class="form-group">
								<label class="control-label" for="small_subject_name">ПІБ директора</label>
								<input type="text" id="small_subject_name" class="form-control" name="" disabled placeholder="Хоменко Андрій Іванович">
							</div>
							<div class="form-group required">
								<label class="control-label" for="subject_status">Статус</label>
								<input type="text" id="subject_status" class="form-control" name="" disabled placeholder="Припинено">
								<p class="help-block help-block-error"></p>
							</div>
							<div class="form-group">
								<button type="submit" class="btn btn-primary btn-block" disabled>Зберегти дані про суб’єкт господарювання (помилка: суб’єкт припинив діяльність)</button>
							</div>
						</div>
					</div>	
				</div>
